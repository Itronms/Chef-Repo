Connect-VIServer itron-p-vm-vc.itronhosting.local -User melliott  -Password Sassaroo1254
$allvms = @()
$allhosts = @()
$hosts = Get-VMHost
...
$allhosts | Select HostName, MemMax, MemAvg, MemMin, CPUMax, CPUAvg, CPUMin | Export-Csv "c:\Temp\Report1.csv" -noTypeInformation
...
$allvms | Select VmName, MemMax, MemAvg, MemMin, CPUMax, CPUAvg, CPUMin | Export-Csv "c:\Temp\Report2.csv" -noTypeInformation