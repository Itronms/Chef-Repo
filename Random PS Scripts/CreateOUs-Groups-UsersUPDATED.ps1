...
try {
    ...
    CreateCustomerGroup "_APP_P_OWCEUI_User" $local:usersou $true
    CreateCustomerGroup "_APP_P_OWCEUI_Admin" $local:usersou $true
	...
	CreateCustomerGroup "_APP_P_ISM_Admin" $local:Applicationsou $false
	CreateCustomerGroup "_APP_P_ISM_User" $local:Applicationsou $false
	...
	CreateCustomerGroup "_APP_P_IEE_Admin" $local:Applicationsou $false
	CreateCustomerGroup "_APP_P_IEE_User" $local:Applicationsou $false
    CreateCustomerGroup "_APP_P_IEECSR_User" $local:Applicationsou $false
